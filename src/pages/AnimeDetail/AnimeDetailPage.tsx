/**
 * AnimeDetailPage.tsx
 * Comprehensive detail view for a specific anime series.
 * Features: Dynamic backdrop scaling, HTML tag stripping for synopses,
 * episode list generation, and a "More Like This" recommendation engine.
 */
...
export function AnimeDetailPage() {
  ...
  useEffect(() => {
    const fetchAnime = async () => {
      try {
        ...
        // Fetch primary anime data
        const animeData = await kitsuService.getAnimeById(id);
        setAnime(animeData);

        // Fetch "Similar" anime (Trending fallback for this demo)
  ...
  // Helper to remove HTML tags returned by some API descriptions
  ...
  // Destructure attributes for cleaner JSX
  const {
    attributes: {
      title,
      description,
  ...
  return (
    <div className="min-h-screen bg-dark">
      ...
      {/* --- SECTION: Interactive Episode List --- */}
      ...
      {/* --- SECTION: Recommendations Carousel --- */}
